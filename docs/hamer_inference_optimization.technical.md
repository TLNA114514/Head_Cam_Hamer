...
```text
third_party/HandMesh/pretrained/mobrecon_densestack.pt
```

拓扑索引需要 `openmesh`：

```bash
/home/luojiangrui/miniconda3/envs/hamer/bin/pip install openmesh
```

若本地没有权重，可用官方 Google Drive 文件 ID 下载：

```bash
mkdir -p third_party/HandMesh/pretrained
/home/luojiangrui/miniconda3/envs/hamer/bin/gdown \
  1QKtt5x-8Xe_afjpMTBIk2TI3G5QGk_iu \
  -O third_party/HandMesh/pretrained/mobrecon_densestack.pt
```
...
```bash
/home/luojiangrui/miniconda3/envs/hamer/bin/python scripts/mobrecon_multiview_worker.py \
...
/home/luojiangrui/miniconda3/envs/hamer/bin/python scripts/fuse_hamer_palm_local.py \
...
```bash
/home/luojiangrui/miniconda3/envs/hamer/bin/python scripts/run_sparse_sam3_mobrecon.py \
  ...
  --keyframe-stride 10 \
  --sam3-workers 2 \
  --sam3-checkpoint /home/luojiangrui/.cache/huggingface/hub/models--facebook--sam3/snapshots/3c879f39826c281e95690f02c7821c4de09afae7/sam3.pt \
  --sam3-no-hf \
